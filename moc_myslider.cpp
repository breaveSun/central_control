...
QT_MOC_LITERAL(4, 28, 14), // "sliderReleased"
QT_MOC_LITERAL(5, 43, 13), // "sliderPressed"
QT_MOC_LITERAL(6, 57, 4), // "move"
QT_MOC_LITERAL(7, 62, 8), // "released"
QT_MOC_LITERAL(8, 71, 7) // "pressed"

    },
    "mySlider\0sliderMoved\0\0value\0sliderReleased\0"
    "sliderPressed\0move\0released\0pressed"
};
...
void mySlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mySlider::sliderMoved)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mySlider::sliderReleased)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (mySlider::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mySlider::sliderPressed)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void mySlider::sliderMoved(int _t1)
{
