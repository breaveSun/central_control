...
QT_MOC_LITERAL(1, 8, 5), // "myUid"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 3), // "uid"
QT_MOC_LITERAL(4, 19, 5) // "print"

    },
    "printer\0myUid\0\0uid\0print"
};
...
void printer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->myUid((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (printer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&printer::myUid)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void printer::myUid(QString _t1)
{
