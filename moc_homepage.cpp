...
QT_MOC_LITERAL(8, 52, 12), // "spacesChange"
QT_MOC_LITERAL(9, 65, 7), // "clicked"
QT_MOC_LITERAL(10, 73, 21), // "spaceChangeWidgetHide"
QT_MOC_LITERAL(11, 95, 11), // "updateRooms"
QT_MOC_LITERAL(12, 107, 11), // "messageList"
QT_MOC_LITERAL(13, 119, 7), // "checked"
QT_MOC_LITERAL(14, 127, 10), // "acceptPush"
QT_MOC_LITERAL(15, 138, 16), // "deviceDataStruct"
QT_MOC_LITERAL(16, 155, 4) // "data"

    },
    "homePage\0goPage\0\0PageBack\0pb\0houseId\0"
    "spaceId\0roomId\0spacesChange\0clicked\0"
    "spaceChangeWidgetHide\0updateRooms\0"
    "messageList\0checked\0acceptPush\0"
    "deviceDataStruct\0data"
};
...
void homePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->spacesChange((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->spaceChangeWidgetHide(); break;
        case 3: _t->updateRooms((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 4: _t->messageList((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: _t->acceptPush((*reinterpret_cast< deviceDataStruct(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (homePage::*)(PageBack , int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&homePage::goPage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void homePage::goPage(PageBack _t1, int _t2, int _t3, int _t4)
{
