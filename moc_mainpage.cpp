...
QT_MOC_LITERAL(1, 9, 16), // "goCtrlListSignal"
...
QT_MOC_LITERAL(8, 62, 12), // "goHomeSignal"
QT_MOC_LITERAL(9, 75, 14), // "goCtrlListSlot"
QT_MOC_LITERAL(10, 90, 10) // "goHomeSlot"

    },
    "mainPage\0goCtrlListSignal\0\0PageBack\0"
    "pb\0houseId\0spaceId\0roomId\0goHomeSignal\0"
    "goCtrlListSlot\0goHomeSlot"
};
...
void mainPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->goCtrlListSignal((*reinterpret_cast< PageBack(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        case 1: _t->goHomeSignal((*reinterpret_cast< PageBack(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        case 2: _t->goCtrlListSlot(); break;
        case 3: _t->goHomeSlot(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (mainPage::*)(PageBack , int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mainPage::goCtrlListSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (mainPage::*)(PageBack , int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mainPage::goHomeSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void mainPage::goCtrlListSignal(PageBack _t1, int _t2, int _t3, int _t4)
{
...
// SIGNAL 1
void mainPage::goHomeSignal(PageBack _t1, int _t2, int _t3, int _t4)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t3))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t4))) };
