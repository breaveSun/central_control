...
QT_MOC_LITERAL(4, 34, 8) // "focusOut"

    },
    "myLineEdit\0mouseReleased\0\0focusIn\0"
    "focusOut"
};
...
void myLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myLineEdit::mouseReleased)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (myLineEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myLineEdit::focusIn)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (myLineEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myLineEdit::focusOut)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void myLineEdit::focusIn()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void myLineEdit::focusOut()
{
